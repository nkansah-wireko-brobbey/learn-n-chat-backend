...
const definePrompt = () => {
    const prompt = ChatPromptTemplate.fromMessages([
        ["system", "Answer the user's question. Search the context for the answer. context: {context}"],
        ["user", "{input}"],
...
const defineTool =async () => {
    ...
    const tool = createRetrieverTool(retriever,{
        ...
        description: "A tool to retrieve information from the constitution of Ghana",
    })
